            ...
            <table class="table table-hover">
                ...
                @forelse($customer_addresses as $address)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('admin.customer_addresses.edit', $address) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="javascript:void(0);" class="btn btn-danger swal-confirm" data-id="{{ $address->id }}">
                                    <i class="fa fa-trash"></i>
                                </a>
                                <form id="delete-form-{{ $address->id }}" action="{{ route('admin.customer_addresses.destroy', $address) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
