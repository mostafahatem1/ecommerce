                        ...
                        <div class="col-3">
                            ...
                            <select name="parent_id" class="form-control">
                                ...
                                @forelse($main_categories as $main_category)
                                    <option value="{{ $main_category->id }}" {{ old('parent_id', $productCategory->parent_id) ==
                                $main_category->id ? 'selected' : null }}>{{ $main_category->name }}</option>
                                @empty
                                @endforelse
                            </select>
            ...
            $("#category-image").fileinput({
                ...
                initialPreview: [
                    @if($productCategory->cover != '')
                        "{{ asset('/backend/uploads/product_categories/'. $productCategory->cover) }}",
                    @endif
                ],
