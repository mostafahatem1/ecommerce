    ...
    <script>
        $(function(){
            $("#admin-image").fileinput({
                ...
                initialPreview: [
                    @if(auth()->user()->user_image != '' && auth()->user()->hasRole('admin'))
                        "{{ asset('backend/uploads/admin/' . auth()->user()->user_image) }}",
                    @elseif(auth()->user()->user_image != '' && auth()->user()->hasRole('supervisor'))
                        "{{ asset('backend/uploads/supervisors/' . auth()->user()->user_image) }}",
                    @endif
