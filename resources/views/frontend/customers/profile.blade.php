            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="col-lg-12 pt-2">
                        <form action="{{ route('frontend.customer.update_profile') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center mb-4">
                                    @if (auth()->user()->user_image != '')
                                        <img src="{{ asset('backend/uploads/customers/' . auth()->user()->user_image) }}" alt="{{ auth()->user()->full_name }}" class="img-thumbnail" width="120">
                                        <div class="mt-2">
                                            <a href="{{ route('frontend.customer.remove_profile_image') }}" class="btn btn-sm btn-outline-danger">Remove image</a>
                                        </div>
                                    @else
                                        <img src="{{ asset('backend/uploads/customers/avatar.svg') }}" alt="{{ auth()->user()->full_name }}" class="img-thumbnail" width="120">
                                    @endif
                                </div>
                                ...
                                <div class="col-lg-6 form-group">
                                    <label class="text-small text-uppercase d-flex" for="password">Password <small
                                ...
                                <div class="col-lg-6 form-group">
                                    <label class="text-small text-uppercase d-flex" for="password_confirmation">Re-Password
